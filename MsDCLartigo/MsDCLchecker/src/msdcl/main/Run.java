...
import util.Util;
import visualization.MatrizManager;
...
//			String extracts = args[2];
		...
		//	MicroservicesSystem system  = getConstraints(architecturalSpecification);			
			...
			MatrizManager matriz = new MatrizManager();
			
			matriz.createMatriz(system);
			String[][] informations = matriz.setMatriz(system);
...
//			matriz.getViolates(driftsCommunications, informations);
//
//			String[][] violates = matriz.updateMatriz(informations);
//
//			String html = matriz.createHtmlTable(violates);
//			
//			// gera o arquivo com as violações
//			OutputManager output = new OutputManager();
//			
//			output.violate( driftsCommunications , "");
//			output.generateHTML(html);
